<?php
    ...
    return [
        ...
        "t_seller_has_canceled_ur_order"                           => ":freelancer has canceled your order",
        "t_seller_has_started_ur_order"                            => ":freelancer has started your order",
        "t_seller_has_delivered_ur_order"                          => ":freelancer has delivered your order",
        "t_seller_sent_u_msg_about_ur_refund_request"              => ":freelancer has sent you a message about your refund request",
        "t_seller_has_accepted_ur_refund"                          => ":freelancer has accepted your refund",
        "t_u_have_declined_this_refund"                            => "You have declined this refund",
        "t_seller_has_declined_ur_refund"                          => ":freelancer has declined your refund",
        ...
        "t_switch_to_selling"                                      => "Switch to Freelancing",
        ...
        "t_how_much_money_can_i_make_answer"                       => "It's totally up to you. You can work as much as you want. Many freelancers work on Riverr full time and some keep their 9-5 job while using Riverr to make extra money.",
