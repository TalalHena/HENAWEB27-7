...
<nav class="w-full {{ $class ? $class : '' }}">
    ...
    @if (auth()->user()->password)
        <a href="{{ url('account/sessions') }}" class="{{ Request::is('account/sessions') ? $link_active_class : $link_basic_class }} hide-on-mobile group ltr:border-l-4 rtl:border-r-4 px-5 py-3 flex items-center text-sm font-medium">
