        ...
        <x-slot name="content">
            <div class="flex items-center justify-center">
                ...
                <div class="grid items-center justify-center mx-1">
                    ...
                    <span class="uppercase font-normal text-gray-500 mt-4 tracking-widest" style="font-size: 10px">{{ __('messages.t_facebook') }}</span>
                </div>
                ...
                <div class="grid items-center justify-center mx-1">
                    ...
                    <span class="uppercase font-normal text-gray-500 mt-4 tracking-widest" style="font-size: 10px">{{ __('messages.t_twitter') }}</span>
                </div>
                ...
                <div class="grid items-center justify-center mx-1">
                    ...
                    <span class="uppercase font-normal text-gray-500 mt-4 tracking-widest" style="font-size: 10px">{{ __('messages.t_linkedin') }}</span>
                </div>
                ...
                <div class="grid items-center justify-center mx-1">
                    ...
                    <span class="uppercase font-normal text-gray-500 mt-4 tracking-widest" style="font-size: 10px">{{ __('messages.t_whatsapp') }}</span>
                </div>
                ...
                <div class="grid items-center justify-center mx-1">
                    ...
                    <template x-if="!isCopied">
                        <span class="uppercase font-normal text-gray-500 mt-4 tracking-widest" style="font-size: 10px">{{ __('messages.t_copy_link') }}</span>
                    </template>
                    <template x-if="isCopied">
                        <span class="uppercase font-normal text-green-500 mt-4 tracking-widest" style="font-size: 10px">{{ __('messages.t_copied') }}</span>
                    </template>
                </div>
