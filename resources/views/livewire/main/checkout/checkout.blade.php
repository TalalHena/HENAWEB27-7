        ...
        <div class="lg:ltr:pl-10 lg:rtl:pr-10">
                                    ...
                                    createOrder: function(data, actions) {
                                        return actions.order.create({
                                            purchase_units: [{
                                                ...
                                                amount    : {
                                                    value: "{{ $total * payment_gateway('paypal')?->exchange_rate }}"
                                                }
                                            }]
                                        });
                                    },
                            ...
                            <script>
                                window.makeFlutterwavePayment = function() {
                                    FlutterwaveCheckout({
                                        ...
                                        amount         : Number("{{ $total * payment_gateway('flutterwave')?->exchange_rate }}"),
                            ...
                            <script>
                                window.makePaystackPayment = function(){
                                    let handler = PaystackPop.setup({
                                        ...
                                        email   : '{{ auth()->user()->email }}',
                                        amount  : Number("{{ $total * payment_gateway('paystack')?->exchange_rate }}") * 100,
                            ...
                            <script>
                                window.makeRazorpayPayment = function() {
                                    ...
                                    var options = {
                                        ...
                                        "amount"     : "{{ $this->amount * payment_gateway('razorpay')?->exchange_rate * 100 }}",
            ...
            <div class="grid md:flex font-medium mt-4 md:rtl:space-x-reverse md:space-x-4 text-gray-500 text-xs space-y-4 md:space-y-0">
                ...
                <div class="flex items-center space-x-1 rtl:space-x-reverse text-green-500 dark:text-green-400">
                    ...
                    <span>@lang('messages.t_ur_transaction_is_secure')</span>
                </div>
                ...
                @if (settings('footer')->terms)
                    ...
                    {{-- Terms of service --}}
                    <a href="{{ url('page', settings('footer')->terms?->slug) }}" class="text-gray-500 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100">
                ...
                @if (settings('footer')->privacy)
                    ...
                    {{-- Privacy policy --}}
                    <a href="{{ url('page', settings('footer')->privacy?->slug) }}" class="text-gray-500 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100">
