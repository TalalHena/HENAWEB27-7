                ...
                <div class="flex items-center space-x-5 rtl:space-x-reverse flex-col md:flex-row">
                    ...
                    <div style="margin-right: 20px">
                            ...
                            <div class="justify-center" style="display: flex;">
                                ...
                                {{-- Level --}}
                                @if ($user->level)
                                    <span class="inline-flex items-center rounded bg-transparent border px-3 py-1 text-xs font-normal tracking-wide" style="color: {{ $user->level->level_color }};border-color: {{ $user->level->level_color }}; margin: 2px;">
