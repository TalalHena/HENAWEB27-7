...
unset($__errorArgs, $__bag); ?>
                    ...
                    <ul class="-mt-4 whitespace-nowrap list-disc list-inside text-slate-500 text-[13px] space-y-2 dark:text-gray-300">
					...
					<?php if(settings('security')->is_recaptcha): ?>
						<div class="col-span-12 flex justify-center" wire:ignore>
			...
			<?php endif; ?>
                    <div class="col-span-12 w-full bg-primary-600 hover:bg-primary-700 text-white py-4.5 px-4 rounded-md text-center mt-6" >
                        <a href="<?php echo e(url('auth/register'), false); ?>" class="text-[13px] font-semibold tracking-wide">
...
<?php $__env->stopPush(); ?><?php /**PATH /data01/virt121463/domeenid/www.turtlecheescake.eu/htdocs/resources/views/livewire/main/auth/login.blade.php ENDPATH**/ ?>