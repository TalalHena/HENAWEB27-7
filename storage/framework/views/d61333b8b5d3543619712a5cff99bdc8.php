                ...
                <div class="flex items-center space-x-5 rtl:space-x-reverse flex-col md:flex-row">
                    ...
                    <div style="margin-right: 20px">
                            ...
                            <div class="justify-center" style="display: flex;">
                                ...
                                <?php if($user->level): ?>
                                    <span class="inline-flex items-center rounded bg-transparent border px-3 py-1 text-xs font-normal tracking-wide" style="color: <?php echo e($user->level->level_color, false); ?>;border-color: <?php echo e($user->level->level_color, false); ?>; margin: 2px;">
                                ...
                                <?php if($user->account_type === 'seller' && !$user->availability): ?>
                                    <span class="inline-flex items-center rounded bg-transparent border border-purple-500 px-3 py-1 text-xs font-normal tracking-wide text-purple-500 whitespace-nowrap" style="margin: 2px">
                                ...
                                <?php if($user->isOnline()): ?>
                                    <span class="inline-flex items-center rounded bg-transparent border border-green-500 px-3 py-1 text-xs font-normal tracking-wide text-green-500 whitespace-nowrap"style="margin: 2px">
                                ...
                                <?php if(!$user->isOnline()): ?>
                                    <span class="inline-flex items-center rounded bg-transparent border border-red-500 px-3 py-1 text-xs font-normal tracking-wide text-red-500 whitespace-nowrap"style="margin: 2px">
...
<?php $__env->stopPush(); ?><?php /**PATH /data01/virt121463/domeenid/www.turtlecheescake.eu/htdocs/resources/views/livewire/main/profile/profile.blade.php ENDPATH**/ ?>