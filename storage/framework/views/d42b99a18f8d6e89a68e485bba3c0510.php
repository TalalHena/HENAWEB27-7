...
<div id="<?php echo e($id, false); ?>" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto fixed top-0 right-0 left-0 z-[60] w-full md:inset-0 h-modal md:h-full" wire:ignore.self x-data="window.<?php echo e($uid, false); ?>" x-init="initialize">
    <div class="relative p-4 w-full <?php echo e($size, false); ?> h-full md:h-auto"  style="padding-top: 100px;">
...
<?php $__env->stopPush(); ?><?php /**PATH /data01/virt121463/domeenid/www.turtlecheescake.eu/htdocs/resources/views/components/forms/modal.blade.php ENDPATH**/ ?>