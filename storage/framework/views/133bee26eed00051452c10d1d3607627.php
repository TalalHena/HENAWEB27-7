...
} elseif ($_instance->childHasBeenRendered('rOUt93X')) {
    $componentId = $_instance->getRenderedChildComponentId('rOUt93X');
    $componentTag = $_instance->getRenderedChildComponentTagName('rOUt93X');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('rOUt93X');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('rOUt93X', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('PqIVZFM')) {
    $componentId = $_instance->getRenderedChildComponentId('PqIVZFM');
    $componentTag = $_instance->getRenderedChildComponentTagName('PqIVZFM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PqIVZFM');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('PqIVZFM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="https://turtlecheescake.eu/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>
...
</html><?php /**PATH /data01/virt121463/domeenid/www.turtlecheescake.eu/htdocs/resources/views/livewire/main/layout/app.blade.php ENDPATH**/ ?>