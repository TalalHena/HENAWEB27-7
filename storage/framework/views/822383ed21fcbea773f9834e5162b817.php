...
} elseif ($_instance->childHasBeenRendered('zN7ssO8')) {
    $componentId = $_instance->getRenderedChildComponentId('zN7ssO8');
    $componentTag = $_instance->getRenderedChildComponentTagName('zN7ssO8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zN7ssO8');
} else {
    $response = \Livewire\Livewire::mount('main.partials.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('zN7ssO8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="https://turtlecheescake.eu/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>
  ...
  <?php /**PATH /data01/virt121463/domeenid/www.turtlecheescake.eu/htdocs/resources/views/livewire/main/seller/layout/app.blade.php ENDPATH**/ ?>