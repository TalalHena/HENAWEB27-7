...
} elseif ($_instance->childHasBeenRendered('NDGsjWS')) {
    $componentId = $_instance->getRenderedChildComponentId('NDGsjWS');
    $componentTag = $_instance->getRenderedChildComponentTagName('NDGsjWS');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NDGsjWS');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('NDGsjWS', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('k54hAIO')) {
    $componentId = $_instance->getRenderedChildComponentId('k54hAIO');
    $componentTag = $_instance->getRenderedChildComponentTagName('k54hAIO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('k54hAIO');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('k54hAIO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /data01/virt121463/domeenid/www.turtlecheescake.eu/htdocs/resources/views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>