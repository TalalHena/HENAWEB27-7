...
<?php $component->withAttributes(['id' => 'modals-share-container','target' => 'modals-share-btn','uid' => 'modal_'.e(uid(), false).'','placement' => 'center-center','size' => 'max-w-2xl']); ?>
         ...
         <?php $__env->slot('content', null, []); ?> 
            <div class="flex items-center justify-center">
                ...
                <div class="grid items-center justify-center mx-1">
                    ...
                    <span class="uppercase font-normal text-gray-500 mt-4 tracking-widest" style="font-size: 10px"><?php echo e(__('messages.t_facebook'), false); ?></span>
                </div>
                ...
                <div class="grid items-center justify-center mx-1">
                    ...
                    <span class="uppercase font-normal text-gray-500 mt-4 tracking-widest" style="font-size: 10px"><?php echo e(__('messages.t_twitter'), false); ?></span>
                </div>
                ...
                <div class="grid items-center justify-center mx-1">
                    ...
                    <span class="uppercase font-normal text-gray-500 mt-4 tracking-widest" style="font-size: 10px"><?php echo e(__('messages.t_linkedin'), false); ?></span>
                </div>
                ...
                <div class="grid items-center justify-center mx-1">
                    ...
                    <span class="uppercase font-normal text-gray-500 mt-4 tracking-widest" style="font-size: 10px"><?php echo e(__('messages.t_whatsapp'), false); ?></span>
                </div>
                ...
                <div class="grid items-center justify-center mx-1">
                    ...
                    <template x-if="!isCopied">
                        <span class="uppercase font-normal text-gray-500 mt-4 tracking-widest" style="font-size: 10px"><?php echo e(__('messages.t_copy_link'), false); ?></span>
                    </template>
                    <template x-if="isCopied">
                        <span class="uppercase font-normal text-green-500 mt-4 tracking-widest" style="font-size: 10px"><?php echo e(__('messages.t_copied'), false); ?></span>
                    </template>
                </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /data01/virt121463/domeenid/www.turtlecheescake.eu/htdocs/resources/views/livewire/main/service/service.blade.php ENDPATH**/ ?>