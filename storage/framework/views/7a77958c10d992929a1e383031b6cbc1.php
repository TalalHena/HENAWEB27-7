    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 mb-16">
        <div class="mx-auto max-w-7xl">
            <div class="lg:flex lg:items-center lg:justify-between">
                ...
                <div style="display:flex" class="mt-5 sm:flex justify-between lg:mt-0 lg:ltr::ml-4 lg:rtl:mr-4">
					...
					<span class="mt-2 sm:mt-0 sm:ltr:ml-3 sm:rtl:mr-3" style="margin-top:0">
...
</div><?php /**PATH /data01/virt121463/domeenid/www.turtlecheescake.eu/htdocs/resources/views/livewire/main/seller/home/home.blade.php ENDPATH**/ ?>