...
unset($__errorArgs, $__bag); ?>
			...
			<?php endif; ?>
                    <div class="col-span-12 w-full bg-primary-600 hover:bg-primary-700 text-white py-4.5 px-4 rounded-md text-center mt-7" >
                        <a href="<?php echo e(url('auth/login'), false); ?>" class="text-[13px] font-semibold tracking-wide">
...
<?php $__env->stopPush(); ?><?php /**PATH /data01/virt121463/domeenid/www.turtlecheescake.eu/htdocs/resources/views/livewire/main/auth/register.blade.php ENDPATH**/ ?>