                                ...
                                createOrder: function(data, actions) {
                                    return actions.order.create({
                                        purchase_units: [{
                                            ...
                                            amount    : {
                                                value: "<?php echo e(($amount - $fee_value) * payment_gateway('paypal')?->exchange_rate, false); ?>"
                                            }
                                        }]
                                    });
                                },
                        ...
                        <script>
                            window.makeFlutterwavePayment = function() {
                                FlutterwaveCheckout({
                                    ...
                                    amount         : Number("<?php echo e($amount * payment_gateway('flutterwave')?->exchange_rate, false); ?>"),
                        ...
                        <script>
                            window.makePaystackPayment = function(){
                                let handler = PaystackPop.setup({
                                    ...
                                    email   : '<?php echo e(auth()->user()->email, false); ?>',
                                    amount  : Number("<?php echo e($amount * payment_gateway('paystack')?->exchange_rate, false); ?>") * 100,
...
<?php $__env->stopPush(); ?><?php /**PATH /data01/virt121463/domeenid/www.turtlecheescake.eu/htdocs/resources/views/livewire/main/account/deposit/deposit.blade.php ENDPATH**/ ?>