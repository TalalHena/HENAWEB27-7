...
<?php endif; ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 max-w-4xl mx-auto lg:divide-x lg:divide-gray-200 lg:dark:divide-zinc-700 rtl:divide-x-reverse space-y-10 lg:space-y-0" x-data="{ selected_method: '' }">
        ...
        <div class="lg:ltr:pl-10 lg:rtl:pr-10">
                                    ...
                                    createOrder: function(data, actions) {
                                        return actions.order.create({
                                            purchase_units: [{
                                                ...
                                                amount    : {
                                                    value: "<?php echo e($total * payment_gateway('paypal')?->exchange_rate, false); ?>"
                                                }
                                            }]
                                        });
                                    },
                            ...
                            <script>
                                window.makeFlutterwavePayment = function() {
                                    FlutterwaveCheckout({
                                        ...
                                        amount         : Number("<?php echo e($total * payment_gateway('flutterwave')?->exchange_rate, false); ?>"),
                            ...
                            <script>
                                window.makePaystackPayment = function(){
                                    let handler = PaystackPop.setup({
                                        ...
                                        email   : '<?php echo e(auth()->user()->email, false); ?>',
                                        amount  : Number("<?php echo e($total * payment_gateway('paystack')?->exchange_rate, false); ?>") * 100,
                            ...
                            <script>
                                window.makeRazorpayPayment = function() {
                                    ...
                                    var options = {
                                        ...
                                        "amount"     : "<?php echo e($this->amount * payment_gateway('razorpay')?->exchange_rate * 100, false); ?>",
            ...
            <div class="grid md:flex font-medium mt-4 md:rtl:space-x-reverse md:space-x-4 text-gray-500 text-xs space-y-4 md:space-y-0">
                ...
                <div class="flex items-center space-x-1 rtl:space-x-reverse text-green-500 dark:text-green-400">
                    ...
                    <span><?php echo app('translator')->get('messages.t_ur_transaction_is_secure'); ?></span>
                </div>
                ...
                <?php if(settings('footer')->terms): ?>
                    ...
                    <a href="<?php echo e(url('page', settings('footer')->terms?->slug), false); ?>" class="text-gray-500 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100">
                ...
                <?php if(settings('footer')->privacy): ?>
                    ...
                    <a href="<?php echo e(url('page', settings('footer')->privacy?->slug), false); ?>" class="text-gray-500 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100">
...
<?php $__env->stopPush(); ?><?php /**PATH /data01/virt121463/domeenid/www.turtlecheescake.eu/htdocs/resources/views/livewire/main/checkout/checkout.blade.php ENDPATH**/ ?>