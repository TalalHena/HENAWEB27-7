<div class="w-full bg-white shadow rounded-lg">
    ...
    <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
        <div class="py-10 px-12">
            ...
            <div class="mb-14">
                <h2 class="text-sm leading-6 font-bold text-gray-900"><?php echo e(__('messages.t_paypal'), false); ?></h2>
...
<?php endif; ?>
                    ...
                    <?php if(settings('paypal')->logo): ?>
                        <div class="mt-3">
                            <img src="<?php echo e(src( settings('paypal')->logo ), false); ?>" class="h-32 rounded-lg intense cursor-pointer object-cover">
                        </div>
                    <?php endif; ?>
                </div>
...
</div>    <?php /**PATH /data01/virt121463/domeenid/www.turtlecheescake.eu/htdocs/resources/views/livewire/admin/services/paypal.blade.php ENDPATH**/ ?>