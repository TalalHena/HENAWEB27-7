...
class CpayController extends Controller
{
    ...
    public function failed(Request $request)
    {
        try {
            ...
            if (Str::startsWith($external_reference, "D-")) {
            ...
            if (Str::startsWith($external_reference, "G-")) {
    ...
    private function checkout($cart, $user, $payment_id)
    {
        try {
            ...
            $invoice->address        = $billing_info->address ? clean($billing_info->address) : null;
            $invoice->status         = 'paid';
            $invoice->save();
        ...
        try {
            ...
            switch ($type) {
                ...
                case 'deposit':
                    ...
                    $fee_percentage_amount = $this->exchange( $amount * $fee_percentage / 100, $this->settings->exchange_rate);
                ...
                case 'gigs':
                    ...
                    // Calculate percentage of this amount 
                    $fee_percentage_amount = convertToNumber($amount * $fee_percentage / 100);
