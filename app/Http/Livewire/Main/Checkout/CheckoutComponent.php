...
class CheckoutComponent extends Component
{
    ...
    private function fee($gateway)
    {
        try {
            ...
            // Set total amount
            $amount = convertToNumber($this->subtotal);
    ...
    public function confirm()
    {
        try {
            ...
            if ($selected) {
                ...
                // Get amount
                $amount = convertToNumber($this->total);
                ...
                switch ($this->selected_method) {
                    ...
                    case 'asaas':
                        ...
                        $request = Http::withHeaders([
                                            ...
                                            "value"               => $amount * $selected->exchange_rate,
                    ...
                    case 'campay':
                        ...
                        if ( is_array($response) && isset($response['token']) ) {
                            ...
                            $payment_request = Http::withToken($response['token'], 'Token')->post("$campay_link/api/get_payment_link/", [
                                ...
                                "amount"               => $amount * $selected->exchange_rate,
                    ...
                    case 'cashfree':
                        ...
                        $request = Http::withHeaders([
                                            ...
                                            "link_id"                     => $payment_id,
                                            "link_amount"                 => $amount * $selected->exchange_rate,
                    ...
                    case 'cpay':
                        ...
                        // Set request params
                        $globalpay         = $amount * $selected->exchange_rate;
                        $arr2              = "G-" . uid(18);
                        $mult              = $globalpay * 100;
                    ...
                    case 'duitku':
                        ...
                        $paymentAmount    = $amount * $selected->exchange_rate;
                        $paymentMethod    = 'VC';
                    ...
                    case 'ecpay':
                        ...
                        $PaymentType       = "aio";
                        $TotalAmount       = $amount * $selected->exchange_rate;
                    ...
                    case 'fastpay':
                        ...
                        $post_data['bill_amount']        = $amount * $selected->exchange_rate;
                    ...
                    case 'freekassa':
                        ...
                        $params['oa']       = $amount * $selected->exchange_rate;
                    ...
                    case 'iyzico':
                        ...
                        $request->setPrice($amount * $selected->exchange_rate);
                        $request->setPaidPrice($amount * $selected->exchange_rate);
                        ...
                        $firstBasketItem->setPrice($amount * $selected->exchange_rate);
                    ...
                    case 'jazzcash':
                        ...
                        // Set order details
                        $pp_amount              = $amount * $selected->exchange_rate * 100;
                        $pp_billref             = "G-" . uid(18);
                    ...
                    case 'mercadopago':
                        ...
                        $item->quantity          = 1;
                        $item->unit_price        = $amount * $selected->exchange_rate;
                    ...
                    case 'mollie':
                        ...
                        // Set amount
                        $amount          = number_format( $amount * $selected->exchange_rate, 2, '.', '' );
                    ...
                    case 'paymob':
                        ...
                        if (isset($auth['token'])) {
                            ...
                            $order   = Http::acceptJson()->post('https://accept.paymob.com/api/ecommerce/orders', [
                                            ...
                                            'amount_cents'    => $amount * $selected->exchange_rate * 100,
                                            'items'           => []
                                        ])->json();
                    ...
                    case 'paytabs':
                        ...
                        $payment  = paypage::sendPaymentCode('all')
                                            ...
                                            ->sendCart( $order_id, $amount * $selected->exchange_rate, __('messages.t_checkout') )
                                            ->sendCustomerDetails(
                    ...
                    case 'razorpay':
                        ...
                        $order   = $request->order->create([
                            'amount'   => $amount * $selected->exchange_rate * 100,
                            'currency' => $selected->currency,
                        ]);
                    ...
                    case 'robokassa':
                        ...
                        $out_summ  = $amount * $selected->exchange_rate;
                    ...
                    case 'vnpay':
                        ...
                        $vnp_OrderType             = "other";
                        $vnp_Amount                = $amount * $selected->exchange_rate * 100;
    ...
    public function offline()
    {
        try {
            ...
            $invoice->address        = $billing_info->address ? clean($billing_info->address) : "NA";
    ...
    $this->notification([
        'title'       => __('messages.t_error'),
        'description' => __('messages.t_toast_something_went_wrong') . ' Error: ' . $th->getMessage(),
        'icon'        => 'error'
    ]);
}
    }
