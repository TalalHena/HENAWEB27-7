...
class DepositComponent extends Component
{
                ...
                switch ($this->selected_method) {
                    ...
                    case 'asaas':
                        ...
                        $request = Http::withHeaders([
                                            ...
                                            "value"               => $this->amount * $selected->exchange_rate,
                    ...
                    case 'campay':
                        ...
                        if ( is_array($response) && isset($response['token']) ) {
                            ...
                            $payment_request = Http::withToken($response['token'], 'Token')->post("$campay_link/api/get_payment_link/", [
                                ...
                                "amount"               => $this->amount * $selected->exchange_rate,
                    ...
                    case 'cashfree':
                        ...
                        $request = Http::withHeaders([
                                            ...
                                            "link_id"                     => $payment_id,
                                            "link_amount"                 => $this->amount * $selected->exchange_rate,
                    ...
                    case 'cpay':
                        ...
                        // Set request params
                        $globalpay         = $this->amount * $selected->exchange_rate;
                        $arr2              = "D-" . uid(18);
                        $mult              = $globalpay * 100;
                    ...
                    case 'duitku':
                        ...
                        $paymentAmount    = $this->amount * $selected->exchange_rate;
                        $paymentMethod    = 'VC';
                    ...
                    case 'ecpay':
                        ...
                        $PaymentType       = "aio";
                        $TotalAmount       = $this->amount * $selected->exchange_rate;
                    ...
                    case 'fastpay':
                        ...
                        $post_data['bill_amount']        = $this->amount * $selected->exchange_rate;
                    ...
                    case 'freekassa':
                        ...
                        $secret_key         = $selected?->settings['merchant_secret'];
                        $pay_url            = $selected?->settings['request_link'];

                        // Set request params
                        $params             = [];
                        $params['o']        = $merchant_id;
                        $params['oa']       = $this->amount * $selected->exchange_rate;
                    ...
                    case 'iyzico':
                        ...
                        $request->setPrice($this->amount * $selected->exchange_rate);
                        $request->setPaidPrice($this->amount * $selected->exchange_rate);
                        ...
                        $firstBasketItem->setPrice($this->amount * $selected->exchange_rate);
                    ...
                    case 'jazzcash':
                        ...
                        // Set order details
                        $pp_amount              = $this->amount * $selected->exchange_rate * 100;
                        $pp_billref             = "D-" . uid(18);
                    ...
                    case 'mercadopago':
                        ...
                        $item->quantity          = 1;
                        $item->unit_price        = $this->amount * $selected->exchange_rate;
                    ...
                    case 'mollie':
                        ...
                        // Set amount
                        $amount          = number_format( $this->amount * $selected->exchange_rate, 2, '.', '' );
                    ...
                    case 'paymob':
                        ...
                        if (isset($auth['token'])) {
                            ...
                            $order   = Http::acceptJson()->post('https://accept.paymob.com/api/ecommerce/orders', [
                                            ...
                                            'amount_cents'    => $this->amount * $selected->exchange_rate * 100,
                                            'items'           => []
                                        ])->json();
                    ...
                    case 'paytabs':
                        ...
                        $payment  = paypage::sendPaymentCode('all')
                                            ...
                                            ->sendCart( $order_id, $this->amount * $selected->exchange_rate, __('messages.t_add_funds') )
                                            ->sendCustomerDetails(
                    ...
                    case 'razorpay':
                        ...
                        $order   = $request->order->create([
                            'amount'   => $this->amount * $selected->exchange_rate * 100,
                            'currency' => $selected->currency,
                        ]);
                    ...
                    case 'robokassa':
                        ...
                        $out_summ  = $this->amount * $selected->exchange_rate;
                    ...
                    case 'stripe':
                        ...
                        $intent = $stripe->paymentIntents->create(
                            [
                                ...
                                'payment_method_types'      => ['card', 'acss_debit', 'afterpay_clearpay', 'alipay', 'cashapp', 'link', 'wechat_pay']
                            ]
                        );
                    ...
                    case 'vnpay':
                        ...
                        $vnp_OrderType             = "other";
                        $vnp_Amount                = $this->amount * $selected->exchange_rate * 100;
    ...
    public function offline()
    {
        try {
            ...
            // Get paid amount
            $amount                  = convertToNumber($this->amount) * convertToNumber($gateway?->exchange_rate);

            // Calculate fee from this amount
            $fee                     = convertToNumber($this->fee('deposit', $amount)['value']); 
    ...
    private function fee($gateway)
    {
        try {
            ...
            $fee_percentage_amount = $this->calculateExchangeRate( $amount * $fee_percentage / 100, $gateway->exchange_rate);
